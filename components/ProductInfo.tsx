...
export default function ProductDetailScreen() {
  ...
  return (
    <View className="flex-1 bg-white">
      <ScrollView>
        ...
        <View className="relative">
          ...
          <View className="flex-row justify-center mt-2">
            {product.images.map((img, idx) => (
              <TouchableOpacity
                key={idx}
                className={`mx-1 w-10 h-10 rounded-md border-2 ${selectedImage === idx ? 'border-orange-500' : 'border-gray-200'}`}
        ...
        <View className="px-4 mt-2">
          ...
          <View className="flex-row items-center mt-1">
            <Text className="text-orange-600 text-2xl font-extrabold mr-2">
        ...
        <View className="flex-row px-4 mt-4 space-x-2">
          ...
          <TouchableOpacity className="flex-1 border border-orange-500 py-3 rounded-lg">
        ...
        <View className="px-4 mt-4 space-y-2">
          ...
          <View className="flex-row items-center bg-purple-50 p-3 rounded-lg">
            ...
            <Text className="ml-2 text-gray-500">100% secure transactions</Text>
          </View>
        </View>

        {/* Seller Card */}
        <View className="px-4 mt-4 bg-gray-50 p-4 rounded-lg flex-row items-center">
        ...
        <View className="px-4 mt-8 mb-24">
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <View className="w-32 h-32 bg-gray-100 rounded-lg mr-3 items-center justify-center">
      ...
      {/* Bottom Bar */}
      <View className="absolute bottom-0 left-0 right-0 flex-row bg-white border-t border-gray-200 p-3">
        <TouchableOpacity className="flex-1 border border-gray-300 rounded-lg py-3 mr-2 items-center">
          <Ionicons name="heart-outline" size={22} color="#F59E42" />
          <Text className="text-orange-500 font-bold">Wishlist</Text>
        </TouchableOpacity>
        <TouchableOpacity className="flex-1 bg-orange-500 rounded-lg py-3 items-center">
